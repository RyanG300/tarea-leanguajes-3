...
carbohidrato('pure de papas con mantequilla', 200, 'imagenes/Carbohidratos/pure.png').
carbohidrato('quinoa con frutos secos', 210, 'imagenes/Carbohidratos/quinoa.png').
carbohidrato('cuscus marroqui', 230, 'imagenes/Carbohidratos/cuscus.png').
carbohidrato('pan integral tostado', 180, 'imagenes/Carbohidratos/pan.png').
carbohidrato('tortilla de maiz', 150, 'imagenes/Carbohidratos/tortilla.png').
carbohidrato('papas al ajillo', 300, 'imagenes/Carbohidratos/papas.png').

carne('pollo en salsa de champinones', 350, blanca, 'imagenes/Proteínas/pollo.png').
carne('res al horno con hierbas', 400, roja, 'imagenes/Proteínas/res.png').
carne('salmon a la plancha con limon', 300, blanca, 'imagenes/Proteínas/salmon.png').
...
vegetal('ensalada Cesar', 150, 'imagenes/Vegetales/cesar.png').
vegetal('brocoli al vapor', 80, 'imagenes/Vegetales/brocoli.png').
vegetal('vegetales salteados', 120, 'imagenes/Vegetales/vegetalesSalteados.png').
vegetal('col rizada con limon', 70, 'imagenes/Vegetales/col.png').
...
vegetal('calabacin al horno', 90, 'imagenes/Vegetales/calabacin.png').
...
postre('pudin de pan', 350, 'imagenes/Postres/pudín.png').
...
entrada('rollitos de jamon y queso', 180, no_vegetariana, 'imagenes/Entradas/rollitos.png').
entrada('gazpacho', 90, vegetariana, 'imagenes/Entradas/gazpacho.png').
entrada('tartar de salmon', 200, no_vegetariana, 'imagenes/Entradas/tartar.png').
